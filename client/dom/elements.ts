...
export const systemInfoInput = requireElement<HTMLTextAreaElement>("#system-info");
export const messageInput = requireElement<HTMLInputElement>("#message");
export const placeMarkerButton = requireElement<HTMLButtonElement>("#place-marker");
export const themeToggleButton = requireElement<HTMLButtonElement>("#theme-toggle");
